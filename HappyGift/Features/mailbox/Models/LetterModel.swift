...
var letterFromBob: Letter = Letter(destinataire: participantStandard.id, userMessage: "Holaaa! Je voudrais une playsation", expediteur: UUID(), signature: "Bob", type: .fromFriendToUser)
